...
def load_data(data_folder,data_cn_path,data_en_path,vocab_cn, vocab_en,data_cn_valid_path,data_en_valid_path,sequence_length,valid_portion=0.05,test_mode=False): #vocab_cn:{token:index}
    """
